...
public class Principal {
    ...
    public Principal() {
        ...
        textos acum = new textos("0", Color.RED, 1600, 200);
        acum.setSize(23);
        arreglodat.add(acum);

        textos fin = new textos("Game Over", Color.RED, 900, 500);
        fin.setSize(100);
        ...
        panelsito.ReFinal(fin);
        panelsito.RefVidas(vida);
        panelsito.RefPuntos(puntos);

        ventanita.add(panelsito);
        
        ventanita.setSize(900, 600);
        ventanita.setVisible(true);
        //hilo h = new hilo(panelsito);
        //h.run();  
    ...
    public ArrayList getArreglodat() {
        return arreglodat;
    }

    public void setArreglodat(ArrayList arreglodat) {
        this.arreglodat = arreglodat;
    }
